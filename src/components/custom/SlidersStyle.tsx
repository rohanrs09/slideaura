      ...
      >
        {
           Design_Styles.map((design,index)=>(
            <div key={index} className={`cursor-pointer ${design.styleName==selectStyle?'p-2 border-2 border-primary rounded-2xl':''

            }`}
            onClick={()=>setSelectStyle(design.styleName)}
            >
              <img src={design.bannerImage}  alt={design.styleName} width={300} height={300} 
